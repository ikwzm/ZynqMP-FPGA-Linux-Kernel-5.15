...
```console
shell$ git tag -a 5.15.108-zynqmp-fpga-generic-7 -m "release 5.15.108-zynqmp-fpga-generic-7"
shell$ echo 7 > .version
```
...
```console
shell$ cp arch/arm64/boot/Image.gz ../vmlinuz-5.15.108-zynqmp-fpga-generic-7
shell$ cp .config             ../files/config-5.15.108-zynqmp-fpga-generic-7
```

### Install devicetree to this repository

```console
shell$ install -d ../devicetrees/5.15.108-zynqmp-fpga-generic-7
shell$ cp arch/arm64/boot/dts/xilinx/* ../devicetrees/5.15.108-zynqmp-fpga-generic-7
```
