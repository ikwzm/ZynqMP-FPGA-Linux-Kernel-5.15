...
```console
shell$ git tag -a 5.15.108-zynqmp-fpga-generic-6 -m "release 5.15.108-zynqmp-fpga-generic-6"
shell$ echo 6 > .version
```
...
```console
shell$ cp arch/arm64/boot/Image.gz ../vmlinuz-5.15.108-zynqmp-fpga-generic-6
shell$ cp .config             ../files/config-5.15.108-zynqmp-fpga-generic-6
```

### Install devicetree to this repository

```console
shell$ install -d ../devicetrees/5.15.108-zynqmp-fpga-generic-6
shell$ cp arch/arm64/boot/dts/xilinx/* ../devicetrees/5.15.108-zynqmp-fpga-generic-6
```
